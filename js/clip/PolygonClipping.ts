...
import { ClipSimplifier, LinearEdge, PolygonalFace, alpenglow } from '../imports.js';
      ...
      for ( let iy = minStepY; iy < maxStepY; iy++ ) {
        ...
        for ( let ix = minStepX; ix < maxStepX; ix++ ) {
          ...
          if ( cellMaxX < minXIntercept - 1e-6 || cellMinX > maxXIntercept + 1e-6 ) {
            ...
            const clipped = PolygonClipping.matthesDrakopoulosClip( clippedStartPoint, clippedEndPoint, cellMinX, cellMinY, cellMaxX, cellMaxY );
