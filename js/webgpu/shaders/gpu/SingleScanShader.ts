...
import { alpenglow, BinaryOp, OldBindingType, ByteEncoder, OldComputeShader, DeviceContext, ExecutableShader, OldExecution, wgsl_main_scan, PipelineBlueprint } from '../../../imports.js';
  ...
  public static async create<T>(
    ...
    const shader = await OldComputeShader.fromSourceAsync(
      deviceContext.device, name, wgsl_main_scan, [
        ...
        valueType: type.valueType( null as unknown as PipelineBlueprint ),
