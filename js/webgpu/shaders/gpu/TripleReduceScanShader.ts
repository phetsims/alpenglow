...
import { alpenglow, OldBindingType, ByteEncoder, OldComputeShader, OldComputeShaderSourceOptions, DeviceContext, ExecutableShader, OldExecution, u32, wgsl_main_reduce, wgsl_main_reduce_non_commutative, wgsl_main_scan, wgsl_main_scan_reduce, wgsl_main_scan_add_2 } from '../../../imports.js';
...
export default class TripleReduceScanShader<T> extends ExecutableShader<T[], T[]> {
  ...
  public static async create<T>(
    ...
    return new TripleReduceScanShader<T>( async ( execution: OldExecution, values: T[] ) => {
